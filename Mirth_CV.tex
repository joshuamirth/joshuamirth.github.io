...
My research interests are in the structure of simplicial complexes such as Vietoris--Rips and \v{C}ech complexes arising in many approaches to persistent homology, discrete Morse theory, and applications of persistent homology to dynamics and computations.
Some current research projects include work on metric thickenings of simplicial complexes and their structure on graphs and geodesic spaces, and a computational project with the Colorado State University pattern analysis lab on using persistent homology to compute a fractal dimension.

% For MN thing:
%Multiparameter persistence is of course closely related to the above topics, and I am interested in developing a better understanding of the state of the art with regard to computational tools for persistent homology.

% For Ohio thing: (should I also apply to the summer school?)
%
I am familiar with and have considerable respect for the work of Matthew Kahle and Facundo Memoli, % is it appropriate to just straight-up say this?
and am excited about the opportunity to develop connections within the topological and geometric data analysis community.
The TGDA workshop and summer school would be an excellent opportunity to develop some knowledge of the algorithmic and statistical aspects of the field.
%\makeletterclosing
